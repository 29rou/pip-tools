...
def test_write_header(writer):
    expected = map(
        ...
        [
            "#",
            f"# This file is autogenerated by pip-compile with python {sys.version_info.major}.{sys.version_info.minor}",
            "# To update, run:",
            "#",
            f'#    pip-compile --output-file={writer.click_ctx.params["output_file"].name} src_file src_file2',
            "#",
        ],
    )
